 ...
 */
final class Version20230825111445 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3ACDEBFE5E237E06 ON productbundle (name)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_3ACDEBFE5E237E06 ON ProductBundle');
    }
}
